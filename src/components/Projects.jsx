    ...
    <section id="projects" className="projects">
      <div className="projects-container">
        ...
        <div className="project-card">
          ...
          <div className="project-info">
            ...
            <div className="project-links">
              <a href="https://github.com/COLLINS15943/" className="project-link" target="_blank" rel="noopener noreferrer">
                Code 
        ...
        <div className="project-card reverse">
          <div className="project-image">
            <a href="https://github.com/COLLINS15943/" target="_blank" rel="noopener noreferrer">
              <img 
          ...
          <div className="project-info">
            ...
            <div className="project-links">
              ...
              <a href="https://github.com/COLLINS15943/" className="project-link live-demo" target="_blank" rel="noopener noreferrer">
                Live Demo 
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M14 3v2h3.59l-9.83 9.83 1.41 1.41L19 6.41V10h2V3m-2 16H5V5h7V3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7h-2v7z"/>
                </svg>
